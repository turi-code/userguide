...
* [Applications](applications/intro.md)
    * [Recommender systems](recommender/introduction.md)
        * [Using trained models](recommender/using-trained-models.md)
    ...
    * [Churn prediction](churn_prediction/quick-start.md)
        ...
        * [How it works](churn_prediction/how-it-works.md)
...
* [Turi Distributed](deployment/pipeline-introduction.md)
